...
class CreateCharacteristicTest {
    ...
    void execute() throws ServletException, AppException, IOException, DBException {
        ...
        CreateCharacteristic underTest = new CreateCharacteristic(characteristicDAO);
        ...
        doNothing().when(characteristicDAO).createCharacteristic(any());
        ...
        verify(characteristicDAO, times(1)).createCharacteristic(any());
    }
}
...
class SearchCompanyTest {
    ...
    void execute() throws ServletException, AppException, IOException, DBException {
        ...
        SearchCompany underTest = new SearchCompany(companyDAO);
        ...
        when(companyDAO.searchCompanies(anyString())).thenReturn(new ArrayList<Company>());
        ...
        verify(companyDAO, times(1)).searchCompanies(anyString());
    }
}